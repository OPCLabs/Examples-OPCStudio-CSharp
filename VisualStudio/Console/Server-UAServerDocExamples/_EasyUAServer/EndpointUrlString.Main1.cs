...
#region Example
// This example shows how to set the URL string of the primary server endpoint.
...
namespace UAServerDocExamples._EasyUAServer
{
    class EndpointUrlString
    {
        public static void Main1()
        {
            ...
            // Set the server endpoint URL string.
            server.EndpointUrlString = "opc.tcp://localhost:38444/";
