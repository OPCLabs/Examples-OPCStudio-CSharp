...
[assembly: AssemblyDescription("This client demo is written in .NET, and it shows how to use the component to work with OPC DA servers. It allows reading and writing items, subscriptions to items, and getting item properties. It also shows the user interface for browsing machines, OPC servers, OPC items and OPC properties.")]
